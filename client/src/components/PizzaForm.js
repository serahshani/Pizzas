  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <input
        ...
        name="price"
        type="number"
        min="1" // Ensure price is at least 1
        max="30" // Ensure price does not exceed 30
        value={price}
        onChange={(e) => setPrice(e.target.value)} // Store as string for now
      />
      {formErrors.length > 0 &&
        formErrors.map((err) => (
